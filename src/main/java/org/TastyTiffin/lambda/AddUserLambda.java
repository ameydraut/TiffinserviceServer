...
public class AddUserLambda  implements RequestHandler<APIGatewayV2HTTPEvent, APIGatewayV2HTTPResponse> {
    ...
    public APIGatewayV2HTTPResponse handleRequest(APIGatewayV2HTTPEvent apiGatewayV2HTTPEvent, Context context) {
        ...
        try {
            AddUserRequest addUserRequest= new ObjectMapper().registerModule(new Jdk8Module()).readValue(body,AddUserRequest.class);
            String id=tastyTiffinService.addUser(addUserRequest);

            apiGatewayV2HTTPResponse.setBody(id);
