...
public class GetProviderLambda implements RequestHandler<APIGatewayV2HTTPEvent, APIGatewayV2HTTPResponse> {
    ...
    public APIGatewayV2HTTPResponse handleRequest(APIGatewayV2HTTPEvent apiGatewayV2HTTPEvent, Context context) {
        ...
        String ProviedrHashkey=parameters.get("providerHashkey");
        GetProviderResponse getProviderResopnse= tastyTiffinService.getProvider(ProviderId,ProviedrHashkey);
        try {
            apiGatewayV2HTTPResponse.setBody(new ObjectMapper().registerModule(new Jdk8Module()).writeValueAsString(getProviderResopnse));
