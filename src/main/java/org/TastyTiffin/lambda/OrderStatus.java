...
import org.TastyTiffin.model.request.OrderStatusRequest;
import org.TastyTiffin.model.request.PlaceOrderRequest;
import org.TastyTiffin.service.TastyTiffinService;

import java.util.HashMap;

public class OrderStatus implements RequestHandler<APIGatewayV2HTTPEvent, APIGatewayV2HTTPResponse> {
    @Override
    public APIGatewayV2HTTPResponse handleRequest(APIGatewayV2HTTPEvent apiGatewayV2HTTPEvent, Context context) {
        ...
        try {
            OrderStatusRequest orderStatusRequest = new ObjectMapper().registerModule(new Jdk8Module()).readValue(body, OrderStatusRequest.class);
            String orderId=tastyTiffinService.orderStatus(orderStatusRequest);

            apiGatewayV2HTTPResponse.setBody(orderId);
