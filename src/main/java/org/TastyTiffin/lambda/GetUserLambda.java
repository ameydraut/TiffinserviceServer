...
public class GetUserLambda implements RequestHandler<APIGatewayV2HTTPEvent, APIGatewayV2HTTPResponse> {
    ...
    public APIGatewayV2HTTPResponse handleRequest(APIGatewayV2HTTPEvent apiGatewayV2HTTPEvent, Context context) {
        ...
        String HashKey=parameters.get("hashkey");
        GetUserResopnse getUserResopnse= tastyTiffinService.getUser(UserId,HashKey);
        try {
            apiGatewayV2HTTPResponse.setBody(new ObjectMapper().registerModule(new Jdk8Module()).writeValueAsString(getUserResopnse));
