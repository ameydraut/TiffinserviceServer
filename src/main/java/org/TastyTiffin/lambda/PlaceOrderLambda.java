...
public class PlaceOrderLambda implements RequestHandler<APIGatewayV2HTTPEvent, APIGatewayV2HTTPResponse> {
    ...
    public APIGatewayV2HTTPResponse handleRequest(APIGatewayV2HTTPEvent apiGatewayV2HTTPEvent, Context context) {
        ...
        try {
            PlaceOrderRequest placeOrderRequest = new ObjectMapper().registerModule(new Jdk8Module()).readValue(body, PlaceOrderRequest.class);
            String orderId=tastyTiffinService.placeOrderRequest(placeOrderRequest);
