...
public class AddFoodItemLambda implements RequestHandler<APIGatewayV2HTTPEvent, APIGatewayV2HTTPResponse> {
    @Override
    public APIGatewayV2HTTPResponse handleRequest(APIGatewayV2HTTPEvent apiGatewayV2HTTPEvent, Context context) {
        ...
        try {
            AddFoodItemRequest addFoodItemRequest = new ObjectMapper().registerModule(new Jdk8Module()).readValue(body,AddFoodItemRequest.class);
            String providerId=tastyTiffinService.addFoodItem(addFoodItemRequest);
